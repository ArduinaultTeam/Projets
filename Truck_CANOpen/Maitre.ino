...
unsigned long int temps_cycle1 = 1200; // Lumière
unsigned long int t1 = 0;
unsigned long int temps_cycle2 = 12000; // Température
unsigned long int t2 = 0;
unsigned long int temps_cycle3 = 125; // Bouton
unsigned long int t3 = 0;
unsigned long int temps_cycle4 = 37; // Potar
...
void loop() {
  ...
  // Code erreur **********
  if ((compteur_erreur_temp >= nombre_erreurs_max) || (compteur_erreur_lum >= nombre_erreurs_max) || (compteur_erreur_bouton >= nombre_erreurs_max) || (compteur_erreur_potar >= nombre_erreurs_max)) {
